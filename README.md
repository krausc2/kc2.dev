...
You can view the live site at either [kc2.dev](kc2.dev) or [krausc2.dev](krausc2.dev).

Fundamentally, creating it was a project to teach myself Svelte 5, and practice web development.
